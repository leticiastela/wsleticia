...
public class Exercicio3 {
	public static void main(String[] args) {
		...
		byte faltas = Byte.parseByte(JOptionPane.showInputDialog("Informe o número de faltas:"));
		float salario = Float.parseFloat(JOptionPane.showInputDialog("Informe o salário bruto:"));
		float valorINSS = 0;
		if(faltas == 0)
		{
		...
		System.out.println("Valor do Salário Líquido: " + (salario-valorFGTS-valorINSS));
